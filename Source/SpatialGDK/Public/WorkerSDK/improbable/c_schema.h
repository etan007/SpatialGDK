...
struct Schema_Fields
{
 ...
 WORKERSDK_API Schema_CommandRequest* Schema_CreateCommandRequest(uint32_t component_id,uint32_t command_index);
 ...
 WORKERSDK_API Schema_CommandResponse* Schema_CreateCommandResponse(uint32_t component_id,uint32_t command_index);
 ...
 WORKERSDK_API Schema_ComponentUpdate* Schema_CreateComponentUpdate(uint32_t id);
  ...
  */
 WORKERSDK_API uint8_t Schema_MergeComponentUpdateIntoUpdate(Schema_ComponentUpdate* update,Schema_ComponentUpdate* target_update,uint32_t cid);
 /**
...
WORKERSDK_API void Schema_Debug2Log(const Schema_Object* object);
 ...
 WORKERSDK_API bool  Schema_IsOnlySecondNameData(const Schema_Object* object);
 ...
 WORKERSDK_API Schema_Fields* Schema_FieldIdsByComponentId(uint32_t cid);
 WORKERSDK_API Schema_Fields* Schema_FieldIds(const Schema_Object* object);
 WORKERSDK_API void Schema_DestorySchemaFileds(Schema_Fields* fields);
